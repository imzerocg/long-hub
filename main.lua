spawn(function()
     ...
     wait(1.5)
     require(game.ReplicatedStorage.Notification).new("<Color=Red> WELECOM TO Long
HUB<Color=/>"):Display()
     require(game.ReplicatedStorage.Notification).new("<Color=Yellow>THÔNG BÁO:BẢN
Script Long Hub Siêu Vip Vn UPDATE<Color=/>"):Display()
end)
-----------------------------------------------------------------------------------
-----------------------------------------------------------
local Fluent =
...
local Tabs = {
     ...
     Teleport = Window:AddTab({ Title = "Dịch chuyển tức thời", Icon =
"palmtree" }),
...
if First_Sea then
if Lv == 1 or Lv <= 9 or SelectMonster == "Bandit" or SelectArea == 'Jungle' then
-- Bandit
Ms = "Bandit"
...
elseif Lv == 450 or Lv <= 474 or SelectMonster == "God's Guard" or SelectArea ==
...
game.Players.LocalPlayer.Character.Humanoid.Sit = true end
        pcall(function() tween =
game:GetService("TweenService"):Create(game.Players.LocalPlayer.Character.HumanoidR
ootPart,TweenInfo.new(Distance/350, Enum.EasingStyle.Linear),{CFrame = Pos}) end)
        tween:Play()
...
-- [Body Gyro]
   spawn(function()
                  while task.wait() do
                        pcall(function()
                              if _G.TeleportIsland or _G.AutoQuestRace or
_G.AutoBuyBoat or _G.dao or _G.AutoMirage or AutoFarmAcient or _G.AutoQuestRace or
Auto_Law or _G.AutoAllBoss or _G.Autotushita or _G.AutoHolyTorch or
_G.AutoTerrorshark or _G.farmpiranya or _G.DriveMytic or _G.AutoDoughKingV2 or
PirateShip or _G.AutoSeaBeast or _G.AutoNear or _G.BossRaid or _G.GrabChest or
AutoCitizen or _G.Ecto or AutoEvoRace or AutoBartilo or AutoFactory or BringChestz
or BringFruitz or _G.AutoLevel or _G.Clip2 or AutoFarmNoQuest or _G.AutoBone or
...
AutoFarmKen or AutoKenHop or AutoKenV2 or KillPlayerMelee or KillPlayerGun or
KillPlayerFruit or AutoDungeon or AutoNextIsland or AutoAdvanceDungeon or Musketeer
or RipIndra or Auto_Serpent_Bow or AutoTorch or AutoSoulGuitar or
Auto_Cursed_Dual_Katana or _G.AutoMaterial or Auto_Quest_Yama_1 or
...
AutoBartilo or AutoEvoRace or _G.Ecto then
                                    if not
...
spawn(function()
  pcall(function()
    game:GetService("RunService").Stepped:Connect(function()
       if _G.TeleportIsland or _G.AutoQuestRace or _G.AutoBuyBoat or _G.dao or
AutoFarmAcient or _G.AutoMirage or Auto_Law or _G.AutoQuestRace or _G.AutoAllBoss
or _G.AutoHolyTorch or _G.Autotushita or _G.farmpiranya or _G.AutoTerrorshark or
_G.AutoNear or _G.AutoDoughKingV2 or PirateShip or _G.AutoSeaBeast or _G.DriveMytic
or _G.BossRaid or _G.GrabChest or AutoCitizen or _G.Ecto or AutoEvoRace or
AutoBartilo or AutoFactory or BringChestz or BringFruitz or _G.AutoLevel or
_G.Clip2 or AutoFarmNoQuest or _G.AutoBone or AutoFarmSelectMonsterQuest or
AutoFarmSelectMonsterNoQuest or _G.AutoBoss or AutoFarmBossQuest or AutoFarmMasGun
or AutoFarmMasDevilFruit or AutoFarmSelectArea or AutoSecondSea or AutoThirdSea or
AutoDeathStep or AutoSuperhuman or AutoSharkman or AutoElectricClaw or
AutoDragonTalon or AutoGodhuman or AutoRengoku or AutoBuddySword or AutoPole or
AutoHallowSycthe or AutoCavander or AutoTushita or AutoDarkDagger or _G.CakePrince
or _G.AutoElite or AutoRainbowHaki or AutoSaber or AutoFarmKen or AutoKenHop or
AutoKenV2 or KillPlayerMelee or KillPlayerGun or KillPlayerFruit or AutoDungeon or
AutoNextIsland or AutoAdvanceDungeon or Musketeer or RipIndra or Auto_Serpent_Bow
or AutoTorch or AutoSoulGuitar or Auto_Cursed_Dual_Katana or _G.AutoMaterial or
Auto_Quest_Yama_1 or Auto_Quest_Yama_2 or Auto_Quest_Yama_3 or Auto_Quest_Tushita_1
or Auto_Quest_Tushita_2 or Auto_Quest_Tushita_3 or _G.Factory or _G.SwanGlasses or
AutoBartilo or AutoEvoRace or _G.Ecto then
       for i,v in
...
Color3.fromRGB(244, 0, 0)), ColorSequenceKeypoint.new(0.32, Color3.fromRGB(146,
255, 251)), ColorSequenceKeypoint.new(0.65, Color3.fromRGB(180, 255, 255)),
...
game:GetService("VirtualInputManager"):SendKeyEvent(true,Enum.KeyCode.End,false,gam
e)
      end)
end
...
    local ToggleAutoFarmLevel = Tabs.Main:AddToggle("ToggleAutoFarmLevel", {Title =
"Auto Farm Level", Default = false })
...
and v.Humanoid.Health > 0 then
          ...
          MonFarm = v.Name
          Click()
          until not _G.AutoLevel or not v.Parent or v.Humanoid.Health <= 0 or not
...
v.Position).Magnitude >= 10 then
     ...
     if
game:GetService("ReplicatedStorage").Effect.Container:FindFirstChild("Death") then
         game:GetService("ReplicatedStorage").Effect.Container.Death:Destroy()
     end
     if
game:GetService("ReplicatedStorage").Effect.Container:FindFirstChild("Respawn")
then
         game:GetService("ReplicatedStorage").Effect.Container.Respawn:Destroy()
     end

    local ToggleMobAura = Tabs.Main:AddToggle("ToggleMobAura", {Title = "Auto Near
Mob", Default = false })
...
    Options.ToggleMasteryFruit:SetValue(false)
    ...
    local ToggleMasteryGun = Tabs.Main:AddToggle("ToggleMasteryGun", {Title = "Auto
Gun Mastery", Default = false })
...
'Queat'
        ...
        pcall(function()
          if BypassTP then
          if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
CFrameMon.Position).Magnitude > 2000 then
          BTP(CFrameMon)
          elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
CFrameMon.Position).Magnitude < 2000 then
          Tween(CFrameMon)
...
0
        ...
        --v.Humanoid:ChangeState(14)
          ...
          MonFarm = v.Name
           ...
           until not AutoFarmMasGun or not v.Parent or v.Humanoid.Health <= 0 or not
game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not TypeMastery ==
'No Quest'
           end
           end
...
      --v.Humanoid:ChangeState(11)
      ...
      Click()
          ...
          until not AutoFarmMasGun or not MasteryType == 'Near Mobs' or not
...
false then
        ...
        if BypassTP then
        if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
CFrameQBoss.Position).Magnitude > 2000 then
        BTP(CFrameQBoss)
        wait(3)
        elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
CFrameQBoss.Position).Magnitude < 2000 then
...
Tween(game:GetService("ReplicatedStorage"):FindFirstChild(SelectBoss).HumanoidRootP
...
ot:InvokeServer(v.HumanoidRootPart.Position,v.HumanoidRootPart)
             ClickCamera()
             end
             end
             end)
...
game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPl
ayer.Data.Gun.Value].RemoteEvent:FireServer(unpack(args))
                       end
                  end)
             end)
        end)
...
--v.Humanoid:ChangeState(14)
  ...
  until not AutoFarmMasDevilFruit or not v.Parent or v.Humanoid.Health == 0 or not
game:GetService("Workspace").Enemies:FindFirstChild(v.Name) or not TypeMastery ==
'No Quest'
  _G.UseSkill = false
  end
...
--v.Humanoid:ChangeState(14)
  ...
  until not AutoFarmMasDevilFruit or not MasteryType == 'Nearest' or not v.Parent
or v.Humanoid.Health == 0 or not TypeMastery == 'Nearest'
  _G.UseSkill = false
  end
...
elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true
then
pcall(function()
  CheckBossQuest()
  if game:GetService("Workspace").Enemies:FindFirstChild(SelectBoss) then
...
Tabs.Main:AddParagraph({
    Title = "Trang trại linh tinh",
    Content = "Bone & Cake Prince & "
})

local ToggleBone = Tabs.Main:AddToggle("ToggleBone", {Title = "Auto Farm Xương ",
Default = false })
...
local ToggleCake = Tabs.Main:AddToggle("ToggleCake", {Title = "Auto Farm Hoàng Tử
Bánh", Default = false })
...
game:GetService("Workspace").Enemies:FindFirstChild("Cake Prince") then
    ...
    for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
    if _G.CakePrince and v.Name == "Cake Prince" and
...
     end
       ...
       if game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other.Transparency ==
0 and (CFrame.new(-1990.672607421875, 4532.99951171875, -14973.6748046875).Position
- game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude >= 2000
then
...
v.Humanoid.Health > 0 then
     if (v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking
Staff" or v.Name == "Head Baker") and v:FindFirstChild("HumanoidRootPart") and
v:FindFirstChild("Humanoid") and v.Humanoid.Health > 0 then
     repeat task.wait()
     AutoHaki()
     EquipTool(SelectWeapon)
...
672),workspace.CurrentCamera.CFrame)
     ...
     if BypassTP then
     if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
cakepos.Position).Magnitude > 2000 then
     BTP(cakepos)
     wait(3)
     elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position -
cakepos.Position).Magnitude < 2000 then
...
"Auto Farm Vật Chất Kì Dị", Default = false })
...
60, 60)
                                          ...
                                          MonFarm = v.Name
                                          Click()
                                      until _G.Ecto == false or not v.Parent or
...
        end
    ...
    if First_Sea then
            tableBoss = {"The Gorilla King","Bobby","Yeti","Mob Leader","Vice
Admiral","Warden","Chief Warden","Swan","Magma Admiral","Fishman
Lord","Wysper","Thunder God","Cyborg","Saber Expert"}
      elseif Second_Sea then
            tableBoss = {"Diamond","Jeremy","Fajita","Don Swan","Smoke
Admiral","Cursed Captain","Darkbeard","Order","Awakened Ice Admiral","Tide Keeper"}
      elseif Third_Sea then
            tableBoss = {"Stone","Island Empress","Kilo Admiral","Captain
Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake
Queen"}
      end
...
if Third_Sea then
    ...
    local ToggleBoat = Tabs.Main:AddToggle("ToggleBoat", {Title = "Auto Buy
Thuyền", Default = false })
...
game:GetService("Workspace").Boats:FindFirstChild("PirateBasic") then
                                  if not
game:GetService("Workspace").Boats:FindFirstChild("PirateBrigade") then
                                      buyb = TPP(CFrame.new(-4513.90087890625,
...
                                          Skillaimbot = false
   ...
   local ToggleTW = Tabs.Main:AddToggle("ToggleTW", {Title = "Auto Nhấn W", Default
= false })
...
"Auto Kill Cá mập khủng bố", Default = false })
...
CFrame.new(posX,posY,posZ))
                                      until not _G.AutoTerrorshark or not v.Parent
...
otPart.CFrame * CFrame.new(2,20,2))
     ...
     local TogglePiranha = Tabs.Main:AddToggle("TogglePiranha", {Title = "Auto Kill
Cá piranha", Default = false })
...
Frame * CFrame.new(posX,posY,posZ))
                                    end
                               else
                                    if
game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") then
...
local ToggleSeaBeAst = Tabs.Main:AddToggle("ToggleSeaBeAst", {Title = "Auto Quái
vật biển", Default = false })
...
local ToggleAutoW = Tabs.Main:AddToggle("ToggleAutoW", {Title = "Auto Nhấn W",
Default = false })
...
local ToggleMirage = Tabs.Main:AddToggle("ToggleMirage", {Title = "Auto Đảo Bí Ẩn",
Default = false })
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
wait(1)
BTPZ(CFrame.new(-5411.22021, 778.609863, -2682.27759, 0.927179396, 0, 0.374617696,
0, 1, 0, -0.374617696, 0, 0.927179396))
...
two(CFrame.new(-5100.7085, 29.968586, -6792.45459, -0.33648631, -0.0396691673,
0.940852463, -6.40461678e-07, 0.999112308, 0.0421253517, -0.941688359,
0.0141740013, -0.336187631))
...
Tween(game:GetService("Workspace").Map:FindFirstChild("MysticIsland").HumanoidRootP
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
           ...
           local ToggleYama = Tabs.Main:AddToggle("ToggleYama", {Title = "Auto Lấy
Yama", Default = false })
...
Tushita", Default = false })
         ...
         local FaiFaoTushita = CFrame.new(-10238.875976563, 389.7912902832, -
9549.7939453125)
         spawn(function()
              while task.wait(.1) do
                  if AutoTushita then
         ...
         function enemyrip()
              ...
              if game.Workspace.Enemies:FindFirstChild("rip_indra True Form") then
                  ...
                  for i,v in pairs(mobs) do
                      if v.Name == "rip_indra True Form" and v:IsA("Model") and
v:FindFirstChild("Humanoid") and
                           v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health
> 0 then
                           return v
                      end
                  end
...
game.Workspace.Enemies:FindFirstChild("Diablo") then
                  local mobs = game.Workspace.Enemies:GetChildren()
                  for i,v in pairs(mobs) do
                      if v.Name == "Deandre" or v.Name == "Diablo" or v.Name ==
"Urban" and v:IsA("Model") and v:FindFirstChild("Humanoid") and
                           v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health
> 0 then
                           return v
                      end
...
         end
         function enemylongma()
             ...
             if game.Workspace.Enemies:FindFirstChild("Longma") then
                 local mobs = game.Workspace.Enemies:GetChildren()
                 for i,v in pairs(mobs) do
                     if v.Name == "Longma" and v:IsA("Model") and
v:FindFirstChild("Humanoid") and
                         v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health
> 0 then
                         return v
...
game.ReplicatedStorage:FindFirstChild("Diablo") then
                     if
game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
                         repeat Tween(CFrame.new(5420.49219, 314.446045, -
2823.07373)) wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
...
ure Red")
                wait(0.5)
                repeat Tween(CFrame.new(-5414.41357, 309.865753, -2212.45776))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-
...
now White")
                wait(0.5)
                repeat Tween(CFrame.new(-4971.47559, 331.565765, -3720.02954))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-
4971.47559, 331.565765, -3720.02954)).Magnitude <= 10
                ...
                wait(0.5)
                repeat Tween(CFrame.new(-5560.27295, 313.915466, -2663.89795))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-
5560.27295, 313.915466, -2663.89795)).Magnitude <= 10
                wait(0.5)
                repeat Tween(CFrame.new(-5561.37451, 313.342529, -2663.4948))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                wait(1)
                repeat Tween(CFrame.new(5154.17676, 141.786423, 911.046326)) wait()
until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                wait(0.2)
                repeat Tween(CFrame.new(5148.03613, 162.352493, 910.548218)) wait()
until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                wait(1)
                ...
                wait(1)
                wait(0.4)
                repeat Tween(CFrame.new(-10752.7695, 412.229523, -9366.36328))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                 wait(0.4)
                 repeat Tween(CFrame.new(-11673.4111, 331.749023, -9474.34668))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                 wait(0.4)
                 repeat Tween(CFrame.new(-12133.3389, 519.47522, -10653.1904))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                 wait(0.4)
                 repeat Tween(CFrame.new(-13336.5, 485.280396, -6983.35254)) wait()
until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                 wait(0.4)
                 repeat Tween(CFrame.new(-13487.4131, 334.84845, -7926.34863))
wait() until not AutoTushita or
(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-
Vector3.new(5420.49219, 314.446045, -2823.07373)).Magnitude <= 10
                 wait(1)
            elseif game.Workspace.Enemies:FindFirstChild("Longma") or
...
    local ToggleFastAttack = Tabs.Setting:AddToggle("ToggleFastAttack", {Title =
"Tấn công nhanh", Default = true })
...
require(game:GetService("ReplicatedStorage").CombatFramework.RigLib)
    spawn(function()
         while task.wait() do
             pcall(function()
                  if not shared.orl then shared.orl = STOPRL.wrapAttackAnimationAsync
end
...
debug.getupvalues(require(game:GetService("Players").LocalPlayer.PlayerScripts.Comb
atFramework))
...
CamShake:Stop()
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Mang
theo đám đông", Default = true })
...
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Bỏ
qua Tp", Default = false })
    ToggleBypassTP:OnChanged(function(Value)
         BypassTP = Value
    end)
    Options.ToggleBypassTP:SetValue(false)
end
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Xóa văn bản
Dame", Default = true })
...
local ToggleZ = Tabs.Setting:AddToggle("ToggleZ", {Title = "Chiêu Z", Default =
true })
...
local ToggleX = Tabs.Setting:AddToggle("ToggleX", {Title = "Chiêu X", Default =
true })
...
local ToggleC = Tabs.Setting:AddToggle("ToggleC", {Title = "Chiêu C", Default =
true })
...
local ToggleV = Tabs.Setting:AddToggle("ToggleV", {Title = "Chiêu V", Default =
true })
ToggleV:OnChanged(function(Value)
     SkillV = Value
end)
Options.ToggleV:SetValue(true)
local ToggleF = Tabs.Setting:AddToggle("ToggleF", {Title = "Chiêu F", Default =
true })
...
---------------------------------------------------------
--Stats
local ToggleMelee = Tabs.Stats:AddToggle("ToggleMelee", {Title = "Auto Cận chiến",
Default = false })
...
local ToggleDe = Tabs.Stats:AddToggle("ToggleDe", {Title = "Auto Phòng thủ",
Default = false })
...
local ToggleSword = Tabs.Stats:AddToggle("ToggleSword", {Title = "Auto Kiếm",
Default = false })
...
local ToggleGun = Tabs.Stats:AddToggle("ToggleGun", {Title = "Auto Súng", Default =
false })
...
local ToggleFruit = Tabs.Stats:AddToggle("ToggleFruit", {Title = "Auto Trái Ác
Quỷ", Default = false })
...
Tabs.Player:AddButton({
    Title = "Làm mới danh sách thả xuống",
...
local ToggleTeleport = Tabs.Player:AddToggle("ToggleTeleport", {Title = "Dịch
chuyển đến người chơi", Default = false })
ToggleTeleport:OnChanged(function(Value)
     _G.TeleportPly = Value
     pcall(function()
          if _G.TeleportPly then
              repeat Tween(game:GetService("Players")
...
local ToggleQuanSat = Tabs.Player:AddToggle("ToggleQuanSat", {Title = "Theo dõi
người chơi", Default = false })
...
local ToggleIsland = Tabs.Teleport:AddToggle("ToggleIsland", {Title = "Dịch
chuyển", Default = false })
ToggleIsland:OnChanged(function(Value)
    _G.TeleportIsland = Value
    if _G.TeleportIsland == true then
        repeat wait()
            if _G.SelectIsland == "WindMill" then
                Tween(CFrame.new(979.79895019531, 16.516613006592,
1429.0466308594))
...
1582.2380371094))
            elseif _G.SelectIsland == "Jungle" then
                Tween(CFrame.new(-1612.7957763672, 36.852081298828,
149.12843322754))
            elseif _G.SelectIsland == "Pirate Village" then
                Tween(CFrame.new(-1181.3093261719, 4.7514905929565,
3803.5456542969))
            elseif _G.SelectIsland == "Desert" then
                Tween(CFrame.new(944.15789794922, 20.919729232788,
4373.3002929688))
            elseif _G.SelectIsland == "Snow Island" then
                Tween(CFrame.new(1347.8067626953, 104.66806030273, -
1319.7370605469))
            elseif _G.SelectIsland == "MarineFord" then
                Tween(CFrame.new(-4914.8212890625, 50.963626861572,
4281.0278320313))
            elseif _G.SelectIsland == "Colosseum" then
                Tween( CFrame.new(-1427.6203613281, 7.2881078720093, -
2792.7722167969))
            elseif _G.SelectIsland == "Sky Island 1" then
                Tween(CFrame.new(-4869.1025390625, 733.46051025391, -
2667.0180664063))
...
Vector3.new(-7894.6176757813, 5547.1416015625, -380.29119873047))
            elseif _G.SelectIsland == "Prison" then
                Tween( CFrame.new(4875.330078125, 5.6519818305969,
734.85021972656))
...
Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
            elseif _G.SelectIsland == "Fountain City" then
                Tween(CFrame.new(5127.1284179688, 59.501365661621,
4105.4458007813))
            ...
            elseif _G.SelectIsland == "The Cafe" then
                Tween(CFrame.new(-380.47927856445, 77.220390319824,
255.82550048828))
            elseif _G.SelectIsland == "Frist Spot" then
                Tween(CFrame.new(-11.311455726624, 29.276733398438,
2771.5224609375))
            elseif _G.SelectIsland == "Dark Area" then
                Tween(CFrame.new(3780.0302734375, 22.652164459229, -3498.5859375))
            elseif _G.SelectIsland == "Flamingo Mansion" then
                Tween(CFrame.new(-483.73370361328, 332.0383605957,
595.32708740234))
            elseif _G.SelectIsland == "Flamingo Room" then
                Tween(CFrame.new(2284.4140625, 15.152037620544, 875.72534179688))
            elseif _G.SelectIsland == "Green Zone" then
                Tween( CFrame.new(-2448.5300292969, 73.016105651855, -
3210.6306152344))
            elseif _G.SelectIsland == "Factory" then
                Tween(CFrame.new(424.12698364258, 211.16171264648, -
427.54049682617))
            elseif _G.SelectIsland == "Colossuim" then
                Tween( CFrame.new(-1503.6224365234, 219.7956237793,
1369.3101806641))
            elseif _G.SelectIsland == "Zombie Island" then
                Tween(CFrame.new(-5622.033203125, 492.19604492188, -
781.78552246094))
            elseif _G.SelectIsland == "Two Snow Mountain" then
                Tween(CFrame.new(753.14288330078, 408.23559570313, -
5274.6147460938))
            elseif _G.SelectIsland == "Punk Hazard" then
                Tween(CFrame.new(-6127.654296875, 15.951762199402, -
5040.2861328125))
            elseif _G.SelectIsland == "Cursed Ship" then
                Tween(CFrame.new(923.40197753906, 125.05712890625, 32885.875))
            elseif _G.SelectIsland == "Ice Castle" then
                Tween(CFrame.new(6148.4116210938, 294.38687133789, -
6741.1166992188))
            elseif _G.SelectIsland == "Forgotten Island" then
                Tween(CFrame.new(-3032.7641601563, 317.89672851563, -
10075.373046875))
            elseif _G.SelectIsland == "Ussop Island" then
                Tween(CFrame.new(4816.8618164063, 8.4599885940552,
2863.8195800781))
            elseif _G.SelectIsland == "Mini Sky Island" then
                Tween(CFrame.new(-288.74060058594, 49326.31640625, -35248.59375))
            elseif _G.SelectIsland == "Great Tree" then
                Tween(CFrame.new(2681.2736816406, 1682.8092041016, -
7190.9853515625))
...
3150.0224609375))
            ...
            elseif _G.SelectIsland == "Port Town" then
                Tween(CFrame.new(-290.7376708984375, 6.729952812194824,
5343.5537109375))
            elseif _G.SelectIsland == "Hydra Island" then
                Tween(CFrame.new(5228.8842773438, 604.23400878906, 345.0400390625))
            elseif _G.SelectIsland == "Floating Turtle" then
                Tween(CFrame.new(-13274.528320313, 531.82073974609, -
7579.22265625))
...
Vector3.new(-12471.169921875, 374.94024658203, -7551.677734375))
             elseif _G.SelectIsland == "Haunted Castle" then
                 Tween(CFrame.new(-9515.3720703125, 164.00624084473,
5786.0610351562))
             elseif _G.SelectIsland == "Ice Cream Island" then
                 Tween(CFrame.new(-902.56817626953, 79.93204498291, -
10988.84765625))
             elseif _G.SelectIsland == "Peanut Island" then
                 Tween(CFrame.new(-2062.7475585938, 50.473892211914, -
10232.568359375))
             elseif _G.SelectIsland == "Cake Island" then
                 Tween(CFrame.new(-1884.7747802734375, 19.327526092529297, -
11666.8974609375))
             elseif _G.SelectIsland == "Cocoa Island" then
                 Tween(CFrame.new(87.94276428222656, 73.55451202392578, -
12319.46484375))
             elseif _G.SelectIsland == "Candy Island" then
                 Tween(CFrame.new(-1014.4241943359375, 149.11068725585938, -
14555.962890625))
             end
...
local ToggleFruit = Tabs.Fruit:AddToggle("ToggleFruit", {Title = "Mua trái cây bắn
tỉa", Default = false })
ToggleFruit:OnChanged(function(Value)
...
local ToggleStore = Tabs.Fruit:AddToggle("ToggleStore", {Title = "Cửa hàng trái
cây", Default = false })
...
Fruit"))
                    ...
                    if
game:GetService("Players").LocalPlayer.Character:FindFirstChild("Bird: Falcon
...
-Bird:
Falcon",game:GetService("Players").LocalPlayer.Backpack:FindFirstChild("Bird:
Falcon Fruit"))
                    end
                    if
...
local ToggleRandomFruit = Tabs.Fruit:AddToggle("ToggleRandomFruit", {Title =
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Thu thập trái
ác quỷ", Default = false })
...
local ToggleEspPlayer = Tabs.Fruit:AddToggle("ToggleEspPlayer", {Title = "Esp người
chơi", Default = false })
...
local ToggleEspFruit = Tabs.Fruit:AddToggle("ToggleEspFruit", {Title = "Esp trái ác
quỷ", Default = false })
...
local ToggleEspIsland = Tabs.Fruit:AddToggle("ToggleEspIsland", {Title = "Esp đảo",
Default = false })
...
local ToggleEspFlower = Tabs.Fruit:AddToggle("ToggleEspFlower", {Title = "Esp hoa",
Default = false })
...
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
     ...
     local ToggleStart = Tabs.Raid:AddToggle("ToggleStart", {Title = "Bắt đầu đột
kích", Default = false })
...
local ToggleKillAura = Tabs.Raid:AddToggle("ToggleKillAura", {Title = "Giết hào
quang", Default = false })
...
local ToggleNextIsland = Tabs.Raid:AddToggle("ToggleNextIsland", {Title = "Đảo tiếp
theo", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Thức tỉnh",
Default = false })
...
local ToggleGetFruit = Tabs.Raid:AddToggle("ToggleGetFruit", {Title = "Lấy Quả Bụng
Thấp", Default = false })
...
elseif Third_Sea then
    Tabs.Raid:AddButton({
        ...
        Description = "",
        Callback = function()
            TP2(CFrame.new(-5017.40869, 314.844055, -2823.0127, -0.925743818,
...
"Auto Acient Quest", Default = false })
...
Tabs.Misc:AddButton({
      Title = "Máy chủ Hop Người chơi thấp",
      Description = "",
      Callback = function()
...
local ToggleRejoin = Tabs.Misc:AddToggle("ToggleRejoin", {Title = "Tự động vào lại
khi bị văng", Description = "",Default = true })
...
if Third_Sea then
local ToggleFindMoon = Tabs.Hop:AddToggle("ToggleFindMoon", {Title = "Tìm trăng
tròn",Description = "", Default = false })
...
spawn(function()
    while wait() do
        ...
        if game:GetService("Lighting").Sky.MoonTextureId=="http://www.roblox.com/
asset/?id=16223659141" or
...
local ToggleMirageIsland = Tabs.Hop:AddToggle("ToggleMirageIsland", {Title = "Tìm
đảo bí ẩn",Description = "", Default = false })
...
local SettingFarm = Tabs.Setting:AddSection("Farming")
    ...
    local ToggleBringMob = Tabs.Setting:AddToggle("ToggleBringMob", {Title = "Gom
Quái",Description = "", Default = true })
    ToggleBringMob:OnChanged(function(Value)
         _G.BringMob = Value
    end)
    Options.ToggleBringMob:SetValue(true)
             ...
             pcall(function()
                 for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
                 if v.Name == MonFarm and (v.HumanoidRootPart.Position -
game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude <= 350 then
                 if InMyNetWork(v.HumanoidRootPart) then
                 v.HumanoidRootPart.CFrame = FarmPos
                 v.Humanoid.JumpPower = 0
...
            return true
    ...
    local ToggleBypassTP = Tabs.Setting:AddToggle("ToggleBypassTP", {Title = "Di
Chuyển Dạng Reset",Description = "", Default = false })
    ToggleBypassTP:OnChanged(function(Value)
         BypassTP = Value
    end)
    Options.ToggleBypassTP:SetValue(false)
...
local ToggleRemove = Tabs.Setting:AddToggle("ToggleRemove", {Title = "Ẩn Dame Đánh
Quái",Description = "", Default = true })
ToggleRemove:OnChanged(function(Value)
...
"Xoá Hết Thông báo",Description = "", Default = false })
ToggleRemoveNotify:OnChanged(function(Value)
    ...
    local ToggleWhite = Tabs.Setting:AddToggle("ToggleWhite", {Title = "Màn hình
Trắng (giảm lag)",Description = "", Default = false })
...
local ToggleZ = Tabs.Setting:AddToggle("ToggleZ", {Title = "Kĩ Năng Z",Description
= "", Default = true })
ToggleZ:OnChanged(function(Value)
     SkillZ = Value
end)
...
local ToggleX = Tabs.Setting:AddToggle("ToggleX", {Title = "Kĩ Năng X", Description
= "",Default = true })
ToggleX:OnChanged(function(Value)
     SkillX = Value
end)
...
local ToggleC = Tabs.Setting:AddToggle("ToggleC", {Title = "Kĩ Năng C",Description
= "", Default = true })
ToggleC:OnChanged(function(Value)
     SkillC = Value
end)
...
local ToggleV = Tabs.Setting:AddToggle("ToggleV", {Title = "",Description = "",
Default = true })
ToggleV:OnChanged(function(Value)
     SkillV = Value
end)
...
local ToggleF = Tabs.Setting:AddToggle("ToggleF", {Title = "Kĩ Năng F",Description
= "", Default = false })
ToggleF:OnChanged(function(Value)
   SkillF = Value
    end)
